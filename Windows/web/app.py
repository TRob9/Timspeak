...
from adapters.stt.windows_speech import WindowsSpeechAdapter
...
def init_adapters():
    ...
    adapter_classes = {
        ...
        'windows_speech': WindowsSpeechAdapter,
    }
...
def setup_stt_interactive():
    ...
    print("  1. Windows Speech Recognition (Fast, free, built-in)")
    ...
    if choice == '1':
        ...
        try:
            subprocess.run(
                ['pip', 'install', '-q', 'pywin32', 'SpeechRecognition'],
                check=True
            )
            print("✓ Windows Speech Recognition is ready!")
            ...
            if 'windows_speech' not in config['stt']['providers']:
                config['stt']['providers']['windows_speech'] = {}

            config['stt']['default'] = 'windows_speech'
            config['stt']['providers']['windows_speech']['enabled'] = True
